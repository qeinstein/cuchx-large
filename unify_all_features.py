...
def main():
    ...
    # Concatenate: 280 (sensor) + 384 (DINOv2) + 512 (ResNet) + 512 (Thermal) = 1688 dimensions
    X_train_unified = np.concatenate([X_sens_tr, X_dino_tr, X_vis_tr, X_thm_tr_full], axis=1)
    X_test_unified = np.concatenate([X_sens_te, X_dino_te, X_vis_te, X_thm_te_full], axis=1)
