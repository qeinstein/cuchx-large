...
SYSTEM = (
    ...
    "sequence return all four letters in temporal order. Return only the answer strings in "
    "the listed question order, separated by |, with no keys or explanation."
)
